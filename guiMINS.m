function varargout = guiMINS(varargin)
% DIALOGMAIN MATLAB code for guiMINS.fig
...
% Edit the above text to modify the response to help guiMINS
...
% --- Executes just before guiMINS is made visible.
function dialogMain_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiMINS (see VARARGIN)

clc;

% Choose default command line output for guiMINS
...
% UIWAIT makes guiMINS wait for user response (see UIRESUME)
